...
| exp-015 | 2026-07-04 | NN (MLP) × 10-seed average | **0.35715** | — | 0.35002 ± 0.00076 (per-seed) | **Big seed-averaging win: +0.00715 vs single-seed NN (0.35000).** MAP@3 is highly seed-sensitive; averaging 10 NN probability matrices before top-3 lifts hugely. Now best single model. 1113s. Saved `nn_te2_s10`. Hill-climb picks it alone (single-seed XGBs too weak to add) → `ensemble` OOF **0.35715** (+0.0146 vs 0.34255). |
